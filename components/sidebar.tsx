  ...
  return (
      <div className='bg-white w-full rounded-xl'>
          <ul className='p-3'>
              ...
              <li className='p-2 text-gray-400 font-bold text-l hover:text-blue-400 ' onClick={() => setSidebar(false)}><Link href='/login'>Login</Link></li>
              <li className='p-2 text-gray-400 font-bold text-l hover:text-blue-400 ' onClick={() => setSidebar(false)}><Link href='/register'>SignUp </Link></li>
